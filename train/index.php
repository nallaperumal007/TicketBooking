			...
			<div id="page-wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<h1><a href="index.php">Online Railway Reservation System in IRCTC</a></h1>
						<nav>
							<a href="#menu">Menu</a>
						</nav>
					</header>
					...
					<nav id="menu">
						<div class="inner">
							...
							<ul class="links">
								...
								<li><a href="http://localhost/Ticket/Home/index.html">Main Page</li>
				...
				<!-- Banner -->
					<section id="banner">
						<div class="inner">
							...
							<h2>Online Railway Reservation System in IRCTC</h2>
					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li></li>
							</ul>
						</div>
					</section>
